...
Timer for Screen Timeout is an Android app for locking phone by counting down then locking the phone. And saved it to persistence DB (Room) to show in history view.
